package com.optic.kev.fragments.client
...
import com.optic.kev.activities.client.update.ClientUpdateActivity
...
class ClientProfileFragment : Fragment() {
    ...
    private fun logout() {
        ...
        val i = Intent(requireContext(), com.optic.kev.activities.MainActivity::class.java)
        startActivity(i)
    }
