package com.optic.kev.activities.client.payments.paypal.form
...
import com.optic.kev.activities.client.payments.paypal.status.ClientPaymentsPaypalStatusActivity
import com.optic.kev.adapters.ShoppingBagAdapter
...
import com.optic.kev.providers.CurrencyProvider
...
class ClientPaymentsPaypalFormActivity : AppCompatActivity() {
            ...
            onApprove = OnApprove { approval ->
                approval.orderActions.capture { captureOrderResult ->
                    ...
                    if (captureOrderResult.toString().contains("Success")) {
                        Toast.makeText(this, "Pago aprovado", Toast.LENGTH_LONG).show()
                        createOrder()
                    }
        ...
        currencyProvider.getCurrencyValue()?.enqueue(object: Callback<JsonObject> {
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                ...
                if (response.body() != null) {
                    var usd = response.body()?.get("USD_COP")?.asDouble
    ...
    private fun createOrder() {
        ...
        val order = com.optic.kev.models.Order(
